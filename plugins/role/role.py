...
class Role(Plugin):
    ...
    def on_handle_context(self, e_context: EventContext):
        ...
        if btype not in [const.OPEN_AI, const.CHATGPT, const.CHATGPTONAZURE, const.QWEN_DASHSCOPE, const.QWEN_DASHSCOPE_APP, const.XUNFEI, const.BAIDU, const.ZHIPU_AI, const.MOONSHOT, const.MiniMax, const.DIFY, const.COZE]:
